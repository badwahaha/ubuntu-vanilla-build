...
EOF
    ...
    # Block snapd from ever being installed (permanent apt pin; matches project goal: no snapd)
...
function install_pkg() {
    ...
    # graphic installer - ubiquity (no slideshow package; not required for installation)
    apt-get install -y \
        ubiquity \
        ubiquity-casper \
