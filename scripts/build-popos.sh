...
EOF
    ...
    # shipped ISO keeps stock APT behavior). HTTPS mirrors/CDNs (Pop!_OS
    # apt.pop-os.org, Brave S3, Mozilla) sometimes close the TLS connection
    # mid-transfer without close_notify; OpenSSL 3 reports that as
